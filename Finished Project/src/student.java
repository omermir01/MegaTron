...
public class student extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(479, 488));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String classification = classification1.getText();
            String major = major1.getText();
            String email = email1.getText();

            String sql = "UPDATE STUDENT SET fName='"+fName+"', lName='"+lName+"', id='"+id+"', gpa='"+gpa+"', classification='"+classification+"', major='"+major+"', email='"+email+"' WHERE id='"+id+"'";
